...
class ImageToPDFConverter:
    def __init__(self, root):
        ...
        self.convert_to_pdf_button = tk.Button(
            self.root,
            text="Convert to PDF",
        ...
        self.select_images_label = tk.Label(
            self.root, text="Select Images", font=("Helvetica", 14)
        )
    ...
    def select_images(self):
        self.image_paths = filedialog.askopenfilenames(
            initialdir="/", title="Select Images", filetypes=(("Image Files", "*.jpg *.png"),)
        )
